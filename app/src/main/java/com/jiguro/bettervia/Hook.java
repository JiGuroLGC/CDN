...
public class Hook implements IXposedHookLoadPackage {
    private static final String MODULE_VERSION_NAME = "1.7.0";
    private static final int MODULE_VERSION_CODE = 20260222;
            ...
            protected void afterHookedMethod(MethodHookParam attachParam) throws Throwable {
                ...
                XposedHelpers.findAndHookMethod(Activity.class, "onDestroy", new XC_MethodHook() {
                    ...
                    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                        ...
                        if (activityName.equals("mark.via.Shell") || activityName.startsWith(currentPackageName + ".Shell")) {
    ...
    private void showPrivacyLockStartupOverlay(final Activity activity, final Context ctx) {
        try {
            ...
            bvLog("[BetterVia] 准备显示验证对话框，密码类型: " + (passwordType == PasswordManager.PASSWORD_TYPE_PATTERN ? "图案" : "数字"));
            int finalPasswordType = passwordType;
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    activity.runOnUiThread(new Runnable() {
            ...
            bvLog("[BetterVia] 隐私锁启动覆盖层已显示，等待验证对话框");
        } catch (Throwable t) {
    ...
    private void setPrivacyLockPageAccessHook(final Context ctx, final ClassLoader cl) {
        try {
            ...
            try {
                XposedHelpers.findAndHookMethod("k.a.y.bb", cl, "B", int.class, String.class,
                        new XC_MethodHook() {
                            @Override
                            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
            ...
            try {
                XposedHelpers.findAndHookMethod("k.a.z.b0.f", cl, "f", int.class,
                        new XC_MethodHook() {
                            @Override
                            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
            ...
            public void run() {
                ...
                privacyLockSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        ...
                        if (isChecked) {
                            ...
                            if (currentPasswordType == PasswordManager.PASSWORD_TYPE_PATTERN) {
                                patternPasswordManager.showVerifyPasswordDialog(
                                        LocalizedStringProvider.getInstance().get(ctx, "pattern_lock_verify_for_disable"));
                            } else if (currentPasswordType == PasswordManager.PASSWORD_TYPE_PIN) {
                                patternPasswordManager.showVerifyPinPasswordDialog(
                ...
                saveBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        putPrivacyLockBoolean(ctx, KEY_PRIVACY_LOCK_APPLY_COMPREHENSIVE, applyComprehensiveCb.isChecked());
                        dialog.dismiss();
                ...
                setPasswordBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!passwordSet) {
                            ...
                            int userSelectedPasswordType = getPrivacyLockInt(ctx, KEY_PRIVACY_LOCK_PASSWORD_TYPE, 0);
    ...
    private void applyAlertDialogTheme(Activity act, Context ctx, AlertDialog dialog) {
        ...
        if (win != null) {
            ...
            if (decorView != null) {
                ...
                if (titleView != null) {
                    titleView.setTextColor(getTextColor(ctx));
                }
                ...
                if (messageView != null) {
                    messageView.setTextColor(getHintColor(ctx));
                }
            ...
            public void run() {
                try {
                    ...
                    if (!remoteVersion.equals(localVersion)) {
                        if (Context != null && Context instanceof Activity) {
                            String finalUpdateLog = updateLog;
                            ((Activity) Context).runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
        ...
        act.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(act, LocalizedStringProvider.getInstance().get(ctx, "thank_user_toast"),
                                Toast.LENGTH_LONG).show();
                    }
                }, 1000);
            }
    ...
    private void checkViaVersion(Context ctx) {
        try {
    ...
    private void showVersionErrorDialog(final Context ctx, final String currentVersion) {
        if (Context == null || !(Context instanceof Activity))
            return;
